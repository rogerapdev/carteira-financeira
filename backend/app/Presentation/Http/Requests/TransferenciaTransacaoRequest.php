...
class TransferenciaTransacaoRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'from_account_id' => 'required|string|exists:accounts,public_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'from_account_id.required' => 'O ID da conta de origem é obrigatório',
            'from_account_id.string' => 'O ID da conta de origem deve ser um UUID válido',
            'from_account_id.exists' => 'Conta de origem não encontrada',
